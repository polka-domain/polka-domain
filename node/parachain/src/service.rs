...
use polka_domain_parachain_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	polka_domain_parachain_runtime::api::dispatch,
	polka_domain_parachain_runtime::native_version,

...
// /root/polka-domain/target/debug/node-template \
// benchmark \
// --chain=dev \
// --steps=50 \
// --repeat=20 \
...
// --heap-pages=4096 \
// --output=/root/polka-domain/pallets/nft/src/weights.rs \
// --template \
// /root/polka-domain/templates/runtime-weight-template.hbs
